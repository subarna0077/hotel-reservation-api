...
SECRET_KEY = 'django-insecure-v_p#(zdg1c8m*z$b^c1hr81&e$^vtue%5oszr38lr!!b%@hoy1'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=45),  # default 15 minutes
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),     # change this to increase refresh token lifetime
